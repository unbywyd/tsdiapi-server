...
export declare function fileLoaderWithContext(pattern: string, context: AppContext, cwd?: string): Promise<void>;
export declare function fileLoader(pattern: string, cwd: string, setToContainer?: boolean): Promise<any[]>;
/**
